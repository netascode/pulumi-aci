...
namespace Pulumi.Aci
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/netascode";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Aci.version.txt");
    ...
    internal sealed class AciResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public AciResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
